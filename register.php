  ...
  <div class="container">
    <form method="POST" action="">
      ...
      <div class="form-group">
        ...
        <input name="pass" type="password" class="form-control" id="InputPassword" placeholder="Пароль">
      </div>
      <div class="form-group">
        <label for="InputPassword">Повторите пароль</label>
        <input name="passrepeat" type="password" class="form-control" id="InputPassword" placeholder="Повторите пароль">
      </div>
